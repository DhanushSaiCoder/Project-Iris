                    ...
                    <div className={styles.StatsDetailsContainer}>
                        {[...Array(5)].map((_, i) => (
                            <div key={i} className={styles.StatsDetailsCard}>
                                <div className={styles.skeletonLine} style={{ width: '60%', height: '24px', marginBottom: '8px' }}></div>
                                <div className={styles.skeletonLine} style={{ width: '80%', height: '12px' }}></div>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className={styles.ActiveUsersDetails}>
                        {[...Array(3)].map((_, i) => (
                            <div key={i} className={styles.UserCard}>
                                <div className={styles.skeletonLine} style={{ width: '70%', height: '16px', marginBottom: '4px' }}></div>
                                <div className={styles.skeletonLine} style={{ width: '50%', height: '12px' }}></div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className={styles.HistoryContainer}>
                    ...
                    <div className={styles.tableContainer}>
                        <table className={styles.HistoryTable}>
                            <thead>
                                <tr>
                                    <th><div className={styles.skeletonLine} style={{ width: '80%', height: '12px' }}></div></th>
                                    <th><div className={styles.skeletonLine} style={{ width: '80%', height: '12px' }}></div></th>
                                    <th><div className={styles.skeletonLine} style={{ width: '80%', height: '12px' }}></div></th>
                                    <th><div className={styles.skeletonLine} style={{ width: '80%', height: '12px' }}></div></th>
                                    <th><div className={styles.skeletonLine} style={{ width: '80%', height: '12px' }}></div></th>
                            ...
                            <tbody>
                                {[...Array(5)].map((_, i) => (
                                    <tr key={i}>
                                        <td><div className={styles.skeletonLine} style={{ width: '90%', height: '12px' }}></div></td>
                                        <td><div className={styles.skeletonLine} style={{ width: '90%', height: '12px' }}></div></td>
                                        <td><div className={styles.skeletonLine} style={{ width: '90%', height: '12px' }}></div></td>
                                        <td><div className={styles.skeletonLine} style={{ width: '90%', height: '12px' }}></div></td>
                                        <td><div className={styles.skeletonLine} style={{ width: '90%', height: '12px' }}></div></td>
                ...
                <div className={chartStyles.ChartsContainer}>
                    ...
                    {[...Array(4)].map((_, i) => (
                        <div key={i} className={chartStyles.chartCard}>
                            <div className={styles.skeletonLine} style={{ width: '70%', height: '20px', marginBottom: '16px' }}></div>
                            <div className={styles.skeletonRect} style={{ width: '100%', height: '250px' }}></div>
                        </div>
                    ))}
                </div>
            </div>
    ...
    return (
        <div className={styles.AdminDashboardPage}>
            ...
            <div className={chartStyles.ChartsContainer}>
                ...
                <div className={chartStyles.chartCard}>
                    <UniqueObjectsDistributionChartInlined sessions={sessions} />
                </div>
                <div className={chartStyles.chartCard}>
