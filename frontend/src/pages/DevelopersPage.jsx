...
import { ChevronLeft, Github, Instagram, Mail, Linkedin } from "lucide-react";
    ...
    const DevelopersDetails = [
        {
            ...
            socialMedia: {
                ...
                linkedin:
                    "https:https://www.linkedin.com/in/dhanush-sai-1517a8273/",
            },
        },
        {
            profileImg: profile,
                    ...
                    {DevelopersDetails.map((developer, index) => (
                        <div key={index} className={styles.developerCard}>
                            ...
                            <div className={styles.DetailsDiv}>
                                <h2 className={styles.developerName}>
                                    {developer.name}
                                </h2>
                                ...
                                <div className={styles.socialLinks}>
                                    ...
                                    {developer.socialMedia.gmail && (
                                        <a
                                            href={`mailto:${developer.socialMedia.gmail}`}
                                            aria-label="Gmail"
                                        >
                                            <Mail
                                                size={20}
